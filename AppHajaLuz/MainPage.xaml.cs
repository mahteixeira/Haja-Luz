...
namespace AppHajaLuz
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("AppHajaLuz.Images.off.jpg");
        ...
        private async void btnOnOff_Clicked(object sender, EventArgs e)
        {
            try
            {
                if (!lanterna_ligada)
                {
                    ...
                    btnOnOff.Source = ImageSource.FromResource("AppHajaLuz.Images.on.jpg");
